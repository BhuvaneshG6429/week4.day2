...
//			5. Click Training shoes
			...
			//wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='sort-selected' and contains(text(),'Popularity')]")));
			Thread.sleep(5000);
...
//			8.Select the price range (900-1200)
			...
			Thread.sleep(5000);
//			9.Filter with color Navy(Note : navy was not available, so selecting black color)
